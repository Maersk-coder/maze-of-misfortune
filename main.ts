...
function Titlescreen () {
    ...
    music.play(music.createSong(assets.song`Titlesong`), music.PlaybackMode.InBackground)
    effects.blizzard.startScreenEffect()
    game.showLongText("Good luck.. Do not die", DialogLayout.Bottom)
    scene.setBackgroundImage(img`
        
...
function Create_enemey () {
    Ghost = sprites.create(img`
        ...
        ........................
        `, SpriteKind.Enemy)
    tiles.placeOnRandomTile(Ghost, sprites.dungeon.collectibleInsignia)
    Ghost.setVelocity(0, 50)
}
...
function Ghost_move () {
    ...
    Ghost.setVelocity(retning[Random_retning][0], retning[Random_retning][1])
}
function Change_level (Level_number: number) {
    ...
    tiles.placeOnRandomTile(Hero, sprites.builtin.forestTiles0)
}
