...
def Titlescreen():
    ...
    """))
    game.splash("Welcome to murdermaze")
    music.play(music.create_song(assets.song("""
            Titlesong
        """)),
        music.PlaybackMode.IN_BACKGROUND)
    effects.blizzard.start_screen_effect()
    game.show_long_text("Good luck.. Do not die", DialogLayout.BOTTOM)
    scene.set_background_image(img("""
        
...
def Create_enemey():
    ...
    Ghost = sprites.create(img("""
        ...
        """),
        SpriteKind.enemy)
    tiles.place_on_random_tile(Ghost, sprites.dungeon.collectible_insignia)
    Ghost.set_velocity(0, 50)
...
def Ghost_move():
    global Random_retning
    Random_retning = randint(0, 3)
    Ghost.set_velocity(retning[Random_retning][0], retning[Random_retning][1])
def Change_level(Level_number: number):
    if Level_number == 1:
        ...
        tiles.set_current_tilemap(tilemap("""
            level11
        """))
    tiles.place_on_random_tile(Hero, sprites.builtin.forest_tiles0)
